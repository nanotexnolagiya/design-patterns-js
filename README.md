...
***
<p align="center">
🎉 Javascriptda loyihalash shablonlari oddiy so'zlar bilan. 🎉
</p>
<p align="center">
Bu mavzu odamlarni o'ylantirib qo'yadigan mavzulardandir. Bu yerda men odamlarni o'ylashga majbur qilaman va <i>sodda</i> tushintirishga harakat qilaman
</p>
...
Loyihalash shablonlari - bu takrorlanadigan muammolarni hal qilish usullari **Muayyan bir muammolarni qanday hal qilish bo'yicha maslahatlar**. Ular **class** ham emas, **package** ham emas va **library** ham emas. Ular, aksincha, ayrim hollarda muayyan muammolarni qanday hal qilish bo'yicha ko'rsatmalar.

⚠️ Ehtiyot bo'ling
-----------------
- Loyihalash shablonlari bu sizning barcha muammolaringizni hal qilish uchun kumush o'q emas.
- Shuni yodda saqlang loyihalash shablonlari bu muamoni hal qilish uchun yechim, ular muammolarni topish uchun yechim emas.
- Ularni to'gri joyda va to'gri ishlatsangizgina sizga foydali bo'lishi mumkin. Aksincha esa kodni chalkashtirib yuboradi halos.
...
- Barcha misollar [ES6](https://github.com/lukehoban/es6features) orqali ifodalangan.
- JavaScriptda loyihalash hsablonlari bir qancha xususiyatlarga ega. Tilda hech qanday interfeys yo'q, shuning uchun biz ba'zi kelishuvlarga amal qilishimiz kerak. Classda m'lum bir **method**lar va **attribute**larga ega bo'lsa, ma'lum bir interfeysni amalga oshiradi deb taxmin qilamiz. Interfeyslar o'zlarining izohlarida tavsiflanadi.

Loyihalash shablonlari turlari
-----------------

* [Yaratilish (Creational)](#creational-design-patterns)
* [Strukturaviy (Structural)](#structural-design-patterns)
* [Xatti-harakatli (Behavioral)](#behavioral-design-patterns)


**Creational** loyihalash shablonlari
==========================

Oddiy so'zlar bilan
> Ba'zan to'g'ridan-to'g'ri **class instance**sini yaratish maqsadga muvofiq emas. Shunda biz **creational** loyihalash shablonlariga e'tibor qaratamiz.
 
 * [Oddiy Fabrika](#-simple-factory)
 * [Fabrikali Usul](#-factory-method)
 * [Abstrakt Fabrika](#-abstract-factory)
 * [Quruvchi](#-builder)
 * [Protorip](#-prototype)
 * [Singlton](#-singleton)
